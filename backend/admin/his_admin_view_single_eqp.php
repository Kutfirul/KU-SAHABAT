                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Peralatan #<?php echo $row->eqp_code;?> Details</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nama Peralatan : <?php echo $row->eqp_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Vendor Peralatan : <?php echo $row->eqp_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Barcode Peralatan: <?php echo $row->eqp_code;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Jumlah Peralatan: <?php echo $row->eqp_qty;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Status Peralatan : <?php echo $row->eqp_status;?></h4>
                                                    <hr>
                                                   <!--

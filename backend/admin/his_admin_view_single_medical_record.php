                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nama : <?php echo $row->mdr_pat_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Umur : <?php echo $row->mdr_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Kode Pasien : <?php echo $row->mdr_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Penyakit Pasien : <?php echo $row->mdr_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Tanggal : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>

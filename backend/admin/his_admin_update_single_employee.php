	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Data Karyawan Berhasil di Update";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Karyawan Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="update_doc" class="ladda-button btn btn-success mt-2" data-style="expand-right">Update</button>

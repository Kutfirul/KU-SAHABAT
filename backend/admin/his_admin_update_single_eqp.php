                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Kelola Peralatan</a></li>
                                                <li class="breadcrumb-item active">Perbaharui Peralatan</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Perbaharui Detail Peralatan</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6" style="display:none">
                                                        <label for="inputPassword4" class="col-form-label">Status Peralatan</label>
                                                        <input required="required" type="text" value="Berfungsi" name="eqp_status" class="form-control"  id="inputPassword4">
                                                    </div>
                                            ...
                                            <button type="submit" name="update_equipments" class="ladda-button btn btn-success" data-style="expand-right">Update Peralatan</button>

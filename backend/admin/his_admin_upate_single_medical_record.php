	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_mdr']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Pasien Medical Record Berhasil Di Update";
			}
			else {
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Manajemen Medical Record</li>
                                            </ol>
                                        </div>
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4" class="col-form-label">Kode Pasien</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Penyakit</label>

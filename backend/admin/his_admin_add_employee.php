                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tambah Detail Karyawan</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputAddress" class="col-form-label">Bagian</label>
                                                <input required="required" type="text" class="form-control" name="doc_dept" id="inputDept">
                                            </div>
                                            </div>
                                            ...
                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Tambah</button>

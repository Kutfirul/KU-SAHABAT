                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Tambah Peralatan</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Tambah Peralatan</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Barcode(EAN-8) Peralatan</label>
                                                    <?php 
                                                        $length = 10;    

	...
	include('assets/inc/config.php');
		if(isset($_POST['reset_pwd']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Silakan Check email anda";
			}
			else {
				$err = "Gagal, Silakan coba kembali";
			}
...
<head>
        <meta charset="utf-8" />
        <title>KU Sahabat Manajemen Sistem</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Masukkan email anda untuk melakukan reset password!</p>
                                </div>
                                ...
                                <form method="post" >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="email" type="email" id="emailaddress" required="" placeholder="Masukkan email anda">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Kembali <a href="index.php" class="text-white ml-1"><b>Log in</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
